...
export function AppSidebar() {
  ...
  return (
    <aside
      className="app-sidebar lg:fixed lg:inset-y-0 lg:left-0 lg:z-30 lg:flex lg:w-[236px] lg:flex-col lg:border-r lg:border-r-[rgba(255,255,255,0.08)] lg:bg-[linear-gradient(180deg,rgba(8,11,15,0.94),rgba(5,7,10,0.98))] lg:shadow-[18px_0_46px_rgba(0,0,0,0.28)] lg:backdrop-blur-[18px]"
