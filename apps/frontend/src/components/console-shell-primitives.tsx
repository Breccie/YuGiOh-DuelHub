...
function TopbarStatusChip({
  ...
  return (
    <Link
      href={href}
      className="group hidden h-12 min-w-0 shrink-0 items-center gap-2.5 rounded-[9px] border border-[rgba(255,255,255,0.08)] bg-[rgba(10,13,18,0.5)] px-3.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] transition hover:border-[rgba(208,170,110,0.24)] hover:bg-[rgba(18,22,28,0.76)] md:flex"
    >
      <AssetIcon
        name={iconName}
        className="h-[18px] w-[18px] text-[#d0b38c] transition group-hover:text-[#f0d6a8]"
      />
      <span className="min-w-0">
        <span className="block truncate text-[0.68rem] uppercase tracking-[0.1em] text-[#a79682]">
          {label}
        </span>
        <span className="block max-w-[9rem] truncate text-[13px] font-semibold text-[#efdfcb]">
          {value}
        </span>
      </span>
    </Link>
  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className="flex h-12 shrink-0 items-center gap-2.5 rounded-[10px] border border-[rgba(255,255,255,0.1)] bg-[rgba(10,13,18,0.62)] px-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] backdrop-blur-md sm:min-w-[168px]"
      >
        ...
        <div className="hidden text-left sm:block">
          ...
          <p className="text-xs uppercase tracking-[0.12em] text-[#9f8c77]">
