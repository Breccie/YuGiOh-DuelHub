  ...
  return (
    <>
        ...
        {consoleNavItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <AssetIcon name={item.iconName} className="h-[26px] w-[26px] text-current" />
        ...
        {primaryMobileItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={classes(
                "flex min-h-[68px] flex-col items-center justify-center gap-1 px-1 py-2 text-[14px] font-semibold transition",
                isActive
      ...
      {moreOpen ? (
        <div
          id="mobile-more-menu"
          className="fixed inset-x-3 bottom-[80px] z-50 rounded-[14px] border border-[rgba(255,255,255,0.1)] bg-[rgba(8,11,15,0.98)] p-2 shadow-[0_24px_60px_rgba(0,0,0,0.5)] backdrop-blur-xl lg:hidden"
        >
