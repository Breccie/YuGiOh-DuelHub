export const binderCoverCatalog = [
  {
    key: "inferno-vortex",
    name: "Inferno Vortex",
    imageUrl: "/app-assets/binders/binder-cover-inferno-vortex-clean.webp",
    accentColor: "#cb5c44",
  ...
  },
  {
    key: "void-eye",
    name: "Void Eye",
    imageUrl: "/app-assets/binders/binder-cover-void-eye-clean.webp",
    accentColor: "#8e62da",
  ...
  },
  {
    key: "storm-eye",
    name: "Storm Eye",
    imageUrl: "/app-assets/binders/binder-cover-storm-eye-clean.webp",
    accentColor: "#4f91ff",
  ...
  },
  {
    key: "golden-dragon",
    name: "Golden Dragon",
    imageUrl: "/app-assets/binders/binder-cover-golden-dragon-clean.webp",
    accentColor: "#d4a661",
