...
export const deckBoxCatalog: readonly DeckBoxMeta[] = [
  {
    ...
    imageUrl: "/app-assets/deckboxes/deckbox-inferno-vortex.webp",
    accentColor: "#ef4f32",
  },
  {
    key: "void-eye",
    ...
    imageUrl: "/app-assets/deckboxes/deckbox-void-eye.webp",
    accentColor: "#a777ff",
  },
  {
    key: "storm-eye",
    ...
    imageUrl: "/app-assets/deckboxes/deckbox-storm-eye.webp",
    accentColor: "#69c7ff",
  },
  {
    key: "golden-dragon",
    ...
    imageUrl: "/app-assets/deckboxes/deckbox-golden-dragon.webp",
    accentColor: "#e8c170",
  },
] as const;
